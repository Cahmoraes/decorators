...
export class Multiplicar extends OperacaoBinaria<string> implements IInit<Multiplicar>, IEventsHandler {

  @DOMInject('#multiplicar_1')
  private _input_1: HTMLInputElement

  @DOMInject('#multiplicar_2')
  private _input_2: HTMLInputElement

  @DOMInject('#resultado_multiplicar')
  ...
  init() {
    this.render({ title: 'Multiplicar:', operation: 'x' }, template)
    this.addEventInputs()
    this.checkValues()
    return this
  }
